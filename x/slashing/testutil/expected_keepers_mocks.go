...
func (m *MockStakingKeeper) Delegation(arg0 context.Context, arg1, arg2 types.AccAddress) (types1.DelegationI, error) {
	m.ctrl.T.Helper()
...
func (m *MockStakingKeeper) Validator(arg0 context.Context, arg1 types.AccAddress) (types1.ValidatorI, error) {
	m.ctrl.T.Helper()
