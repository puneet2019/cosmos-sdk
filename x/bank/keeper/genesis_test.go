...
func (suite *KeeperTestSuite) TestTotalSupply() {
	...
	balances := []types.Balance{
		{Coins: sdk.NewCoins(sdk.NewCoin("foocoin", sdkmath.NewInt(1))), Address: "0x181BCD1E7b5Fd955538D127D25062F5E0eea5E53"},
		{Coins: sdk.NewCoins(sdk.NewCoin("barcoin", sdkmath.NewInt(1))), Address: "0x3E0139AAC906C3C2A8E29F261ae96c6B92cf6E99"},
		{Coins: sdk.NewCoins(sdk.NewCoin("foocoin", sdkmath.NewInt(10)), sdk.NewCoin("barcoin", sdkmath.NewInt(20))), Address: "0x31c8a344DFFA9DD97CCd149266d5Ee338b229DfC"},
	}
